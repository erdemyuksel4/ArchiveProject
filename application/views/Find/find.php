...
<script>
    ...
    function yer(val){
        ...
        this.select.valuePart =  "id";
        this.update = ()=>{
            return this.select.Update("<?=base_url("MissionPlaces/PlaceList")?>",val);
        }
        this.AddStarter = ()=>{
    ...
    function okul(val){
        ...
        this.select.valuePart =  "id";
        this.update = ()=>{
            return this.select.Update("<?=base_url("Schools/SchoolList")?>",val);
        }
        this.AddStarter = ()=>{
        ...
        this.onChangeEvent = ()=>{
            ...
            if(this.select.select.value != "Okul"){
                ...
                a.update().then(()=>{
                    if("<?=$filtre["sinif"]?>"!= ""){
                        a.select.selected("<?=$filtre["sinif"]?>");
                        a.onChangeEvent();
                    }
                });
                a.AddStarter();
    ...
    function sinif(val){
        ...
        this.update = ()=>{
            return this.select.Update("<?=base_url("Schools/ClassList")?>",val);
        }
        this.AddStarter = ()=>{
        ...
        this.onChangeEvent = ()=>{
            ...
            if(this.select.select.value != "Sınıf"){
                ...
                a.update().then(()=>{
                    if("<?=$filtre["ogrenciId"]?>"!= ""){
                        a.select.selected("<?=$filtre["ogrenciId"]?>");
                        a.onChangeEvent();
                    }
                });
                a.AddStarter();
