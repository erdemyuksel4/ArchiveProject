<form action="<?=base_url($location)?>" method="post" id="form">
    <div class="row py-2">
        <div class="input-group flex-nowrap col">
            ...
            <select name="yetkiId" id="" class="form-control" >
                <?php 
                foreach($yetkiler as $yetki){
                    ?>
                    <option value="<?=$yetki["id"]?>" <?=$yetki["id"]==$yetkiId?"selected":""?>><?=$yetki["yetkiAdi"]?></option>
                    <?php
                }
                ?>
            </select>
    ...
    <div class="row py-2">
        <div class="input-group flex-nowrap col">
            ...
            <input type="text" class="form-control" placeholder="Sayfa Adı" name="sayfaAdi" value="<?=$sayfaAdi?>">
    ...
    <div class="row py-2">
        <div class="input-group flex-nowrap col">
            ...
            <input type="text" name="sayfaYol" id="" class="form-control" placeholder="Sayfa Yolu"value="<?=$sayfaYol?>">
        </div>
    </div>
    <div class="row py-2">
        <div class="input-group flex-nowrap col">
            ...
            <input type="checkbox" class="m-2" name="altSayfalar" <?=$altSayfalar==1?"checked":""?>>
        </div>
    </div>
</form>