<div class="container">
    <div class="card">
        <div class="card-header">
            Karne &nbsp;
            <button type="button" class="btn btn-sm btn-primary btn-yazdir" data-area="#print">Yazdır</button>
        </div>
                    ...
                    <?php
                     if ($i==1) {
                        $i=0;
                            ...
                            <?php
                        if($data[array_key_last($data)]["id"]!=$og["id"]){
                            ?>
