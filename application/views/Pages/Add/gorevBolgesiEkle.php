<div class="container">
    ...
    <div class="row">
        <section class="card col">
            <form method="POST" action="<?=base_url("/MissionAreas/Add")?>">
                            ...
                            <div class="container">
                                ...
                                <div class="row py-2">
                                    <div class="input-group flex-nowrap col">
                                        ...
                                        <input type="text" class="form-control" placeholder="Bölge Adı" name="bolgeAdi" required>
                                    </div>
                                ...
                                <div class="row py-2">
                                    <div class="input-group flex-nowrap col">
                                        ...
                                        <textarea class="summernote" name="genelBilgi"></textarea>
                                    </div>
                                ...
                                <div class="row py-2">
                                    <div class="input-group flex-nowrap col">
                                        ...
                                        <textarea class="summernote" name="ogrenciProfili"></textarea>
                                    </div>
